...
let Currency = class Currency extends audit_entity_1.Audit {
};
exports.Currency = Currency;
__decorate([
    (0, typeorm_1.Column)({ name: 'code', unique: true, length: 3 }),
...
__decorate([
    (0, typeorm_1.Column)({ name: 'symbol', length: 10 }),
    __metadata("design:type", String)
...
exports.Currency = Currency = __decorate([
    ...
    (0, typeorm_1.Index)('idx_currencies_code', ['code']),
    (0, typeorm_1.Index)('idx_currencies_is_active', ['isActive'])
], Currency);
