...
let EventType = class EventType extends audit_entity_1.Audit {
};
...
exports.EventType = EventType = __decorate([
    (0, typeorm_1.Entity)('event_types'),
    (0, typeorm_1.Index)('idx_event_types_name', ['name']),
    (0, typeorm_1.Index)('idx_event_types_is_active', ['isActive'])
], EventType);
